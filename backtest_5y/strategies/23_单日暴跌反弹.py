...
策略描述：
  当跌幅超过7%并且收盘价在20日均线之上时买入；当盈利超过6%或者亏损超过5%时卖出；最长持有8天。
...
PARAMS = {
    ...
    "slip_permil": 0.5,            # 滑点 ‰
    "take_profit": 0.06,           # 止盈，0=关闭
    "stop_loss":   0.05,           # 止损，0=关闭
    "max_bars":    8,              # 最长持有交易日，0=不限
